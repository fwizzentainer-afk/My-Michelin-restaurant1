...
" hover-elevate active-elevate-2",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm border-destructive/40",
        outline:
          // @replit Shows the background color of whatever card / sidebar / accent background it is inside of.
          // Inherits the current text color. Uses shadow-xs. no shadow on active
          // No hover state
          "border border-border bg-card/60 text-foreground shadow-xs active:shadow-none",
        secondary:
          // @replit border, no hover, no shadow, secondary border.
          "border bg-secondary text-secondary-foreground border border-secondary/40",
        // @replit no hover, transparent border
        ghost: "border border-transparent hover:bg-secondary/80",
